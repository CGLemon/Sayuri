...
public:
    ...
    static constexpr int kPlaneChannels_V3 = kInputChannels_V3;
    ...
    /*
     * Get the v1, v2 Network input planes.
     *
     ...
     *
     */
    std::vector<float> GetPlanes_V3(const GameState &state, int symmetry = Symmetry::kIdentitySymmetry) const;
