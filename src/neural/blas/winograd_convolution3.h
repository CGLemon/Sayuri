...
private:
    static void
    TransformIn(const int board_size, const std::vector<float>& in, std::vector<float>& V, int C);
    ...
    static void
    TransformOut(const int board_size, const std::vector<float>& M, std::vector<float>& Y, int K);
};
