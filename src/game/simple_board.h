...
public:
    ...
    std::uint32_t GetPattern3x3(const int vtx, const int color) const;
...
inline std::uint32_t SimpleBoard::GetPattern3x3(const int vtx, const int color) const {
    ...
    return *std::min_element(hash_arr, hash_arr+8);
}
