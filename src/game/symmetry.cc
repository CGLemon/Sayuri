...
void Symmetry::PartInitialize(int boardsize) {
    ...
    const auto GetIndex = [boardsize](int x, int y) -> int { return y * boardsize + x; };
...
std::pair<int, int>
Symmetry::GetSymmetry(const int x, const int y, const int symmetry, const int boardsize) const {
